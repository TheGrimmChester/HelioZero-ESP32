...
String Source = "JsyMk194";
String Source_data = "JsyMk194";
byte dhcpOn = 1;
...
unsigned int peer_port = 80;
String peer_path = "/api/v1/measurements";
String peer_protocol = "json";
unsigned long peer_last_poll_ms = 0;
bool peer_last_poll_ok = false;
String peer_last_poll_err = "";
String peer_last_poll_preview = "";
String peer_last_poll_protocol = "";
